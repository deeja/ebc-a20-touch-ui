...
PRESETS: dict[str, BatteryPreset] = {
    ...
    "lifepo4_4s": BatteryPreset("LiFePO4 12V/4S", 12800, 14600, 10000, 100, per_cell=False,
                                 note="4 cells in series - the common 12V-nominal LiFePO4 drop-in pack size."),
    "lto": BatteryPreset("LTO (Titanate)", 2400, 2700, 1500, 100, per_cell=True,
                          note="Li-based - CC-CV charge is correct. Low per-cell voltage allows more series cells."),
    "leadacid6v": BatteryPreset("Pb 6V", 6000, 7200, 5250, 200, per_cell=False),
    "leadacid12v": BatteryPreset("Pb 12V", 12000, 14400, 10500, 200, per_cell=False),
